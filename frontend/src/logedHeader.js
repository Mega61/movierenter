...
class LogedHeader extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            alquiladas: this.props.pelisAlquiladas,
            usuarioLog: this.props.usuarioLogeado
        }
    }
    ...
    updateContador() {
        ...
        if (this.state.alquiladas !== undefined) {
            this.setState({ alquiladas: this.props.pelisAlquiladas })
        }
    ...
    render() {
        ...
        return (
            <div>
                <svg class="headerLogged">
                    <rect id="headerLogged" rx="0" ry="0" x="0" y="0" width="1920" height="110">
                    </rect>
                </svg>
                <div id="LogopaginaLogged">
